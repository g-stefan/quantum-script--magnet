...
#	define XYO_QUANTUMSCRIPT_EXTENSION_MAGNET_EXPORT XYO_PLATFORM_LIBRARY_EXPORT
#else
#	define XYO_QUANTUMSCRIPT_EXTENSION_MAGNET_EXPORT XYO_PLATFORM_LIBRARY_IMPORT
#endif
